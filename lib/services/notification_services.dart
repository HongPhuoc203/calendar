...
//       // Check if the scheduled time is in the future with buffer
//     //  final now = DateTime.now();
//       final now = tz.TZDateTime.now(tz.local);
//       if (scheduledTime.isBefore(now.add(Duration(seconds: 10)))) {
...
//       // Use different scheduling strategies based on platform and timing requirements
//       if (useExactTiming && Platform.isAndroid) { // đây có ý nghĩa là chỉ dùng cho Android
//         // For exact timing, use exactAlarmClock mode
...
//           payload: payload,
//         );
//       } else {//còn đây là dùng cho iOS và Android
...
//   // đây là hàm để lập lịch nhiều thông báo
//   // với các khoảng thời gian khác nhau, dùng để lập lịch các thông báo lặp lại
...
//   // Test method to verify notification timing
//   Future<void> testNotificationTiming() async {
//     final now = DateTime.now();
    
//     // Test notifications at different intervals
//     await scheduleNotification(
//       id: 9999,
//       title: 'Test Notification - 30 seconds',
//       body: 'This should appear in 30 seconds',
//       scheduledTime: now.add(Duration(seconds: 30)),
//       useExactTiming: true,
//     );
...
//       scheduledTime: now.add(Duration(minutes: 2)),
//       useExactTiming: false,
//     );
    
//     print('[NotificationService] Test notifications scheduled');
//     await debugScheduledNotifications();
//   }
// }
